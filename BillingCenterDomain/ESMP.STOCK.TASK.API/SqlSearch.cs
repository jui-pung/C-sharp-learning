        ...
        public List<HDBRH> selectHDBRH(object o)
        {
            ...
            try
            {
                ...
                using (SqlDataReader reader = sqlCmd.ExecuteReader())
                {
                    ...
                    {
                        var row = new HDBRH();
                        row.BHNO = reader.IsDBNull(0) ? "" : reader["BHNO"].ToString();
                        row.TDATE = reader.IsDBNull(1) ? "" : reader["TDATE"].ToString();
                        row.DSEQ = reader.IsDBNull(2) ? "" : reader["DSEQ"].ToString();
                        row.DNO = reader.IsDBNull(3) ? "" : reader["DNO"].ToString();
                        row.RDATE = reader.IsDBNull(4) ? "" : reader["RDATE"].ToString();
                        row.RDSEQ = reader.IsDBNull(5) ? "" : reader["RDSEQ"].ToString();
                        row.RDNO = reader.IsDBNull(6) ? "" : reader["RDNO"].ToString();
                        row.CSEQ = reader.IsDBNull(7) ? "" : reader["CSEQ"].ToString();
                        row.RCODE = reader.IsDBNull(8) ? "" : reader["RCODE"].ToString();
                        row.STOCK = reader.IsDBNull(9) ? "" : reader["STOCK"].ToString();
                        row.SPRICE = reader.IsDBNull(10) ? 0 : Convert.ToDecimal(reader["SPRICE"].ToString());
                        row.SQTY = reader.IsDBNull(11) ? 0 : Convert.ToDecimal(reader["SQTY"].ToString());
                        row.CQTY = reader.IsDBNull(12) ? 0 : Convert.ToDecimal(reader["CQTY"].ToString());
                        row.CDBAMT = reader.IsDBNull(13) ? 0 : Convert.ToDecimal(reader["CDBAMT"].ToString());
                        row.CGTAMT = reader.IsDBNull(14) ? 0 : Convert.ToDecimal(reader["CGTAMT"].ToString());
                        row.CGTINT = reader.IsDBNull(15) ? 0 : Convert.ToDecimal(reader["CGTINT"].ToString());
                        row.CDNAMT = reader.IsDBNull(16) ? 0 : Convert.ToDecimal(reader["CDNAMT"].ToString());
                        row.CDNINT = reader.IsDBNull(17) ? 0 : Convert.ToDecimal(reader["CDNINT"].ToString());
                        row.CDLFEE = reader.IsDBNull(18) ? 0 : Convert.ToDecimal(reader["CDLFEE"].ToString());
                        row.LBFINT = reader.IsDBNull(19) ? 0 : Convert.ToDecimal(reader["LBFINT"].ToString());
                        row.SFEE = reader.IsDBNull(20) ? 0 : Convert.ToDecimal(reader["SFEE"].ToString());
                        row.TAX = reader.IsDBNull(21) ? 0 : Convert.ToDecimal(reader["TAX"].ToString());
                        row.DBFEE = reader.IsDBNull(22) ? 0 : Convert.ToDecimal(reader["DBFEE"].ToString());
                        row.BPRICE = reader.IsDBNull(23) ? 0 : Convert.ToDecimal(reader["BPRICE"].ToString());
                        row.BQTY = reader.IsDBNull(24) ? 0 : Convert.ToDecimal(reader["BQTY"].ToString());
                        row.BFEE = reader.IsDBNull(25) ? 0 : Convert.ToDecimal(reader["BFEE"].ToString());
                        row.INCOME = reader.IsDBNull(26) ? 0 : Convert.ToDecimal(reader["INCOME"].ToString());
                        row.COST = reader.IsDBNull(27) ? 0 : Convert.ToDecimal(reader["COST"].ToString());
                        row.PROFIT = reader.IsDBNull(28) ? 0 : Convert.ToDecimal(reader["PROFIT"].ToString());
                        row.SFCODE = reader.IsDBNull(29) ? "" : reader["SFCODE"].ToString();
                        row.STINTAX = reader.IsDBNull(30) ? 0 : Convert.ToDecimal(reader["STINTAX"].ToString());
                        row.HEALTHFEE = reader.IsDBNull(31) ? 0 : Convert.ToDecimal(reader["HEALTHFEE"].ToString());
                        row.TRDATE = reader.IsDBNull(32) ? "" : reader["TRDATE"].ToString();
                        row.TRTIME = reader.IsDBNull(33) ? "" : reader["TRTIME"].ToString();
                        row.MODDATE = reader.IsDBNull(34) ? "" : reader["MODDATE"].ToString();
                        row.MODTIME = reader.IsDBNull(35) ? "" : reader["MODTIME"].ToString();
